...
export class UpdateTableUser1622728326986 implements MigrationInterface {
    name = 'UpdateTableUser1622728326986'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_user" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "login" varchar NOT NULL, "password" varchar NOT NULL, "email" varchar NOT NULL, "phone" varchar NOT NULL, "cpf" varchar NOT NULL, "birthDate" datetime NOT NULL, "nameMother" varchar NOT NULL, "inclusionDate" datetime, "changeDate" datetime)`);
