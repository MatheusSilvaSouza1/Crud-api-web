...
export class AddFieldsDisabledInactive1622754436423 implements MigrationInterface {
    name = 'AddFieldsDisabledInactive1622754436423'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_user" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "login" varchar NOT NULL, "password" varchar NOT NULL, "email" varchar NOT NULL, "phone" varchar NOT NULL, "cpf" varchar NOT NULL, "birthDate" datetime NOT NULL, "nameMother" varchar NOT NULL, "inclusionDate" datetime, "changeDate" datetime, "disabled" boolean NOT NULL DEFAULT (0), "inactive" boolean NOT NULL DEFAULT (0))`);
